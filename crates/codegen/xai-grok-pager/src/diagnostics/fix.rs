...
pub const SSH_WRAP_ONE_OFF: &str = "open-grok wrap ssh <host>";

const MANAGED_NAMESPACE: &str = "grok doctor";
const SSH_WRAP_ALIAS_POSIX: &str = "alias ssh='open-grok wrap ssh'";
const SSH_WRAP_ALIAS_FISH: &str = "alias ssh 'open-grok wrap ssh'";
