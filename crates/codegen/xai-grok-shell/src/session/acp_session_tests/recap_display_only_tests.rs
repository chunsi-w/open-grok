    ...
    local
        .run_until(async {
            ...
            *actor.agent.borrow_mut() = test_agent_with_goal_tool().await;
            ...
            let main_turn_specs = actor.turn_base_tool_specs(
                &actor.prepare_tool_definitions().await,
        ...
        .run_until(async {
            ...
            *actor.agent.borrow_mut() = test_agent_with_goal_tool().await;
            ...
            let provider = actor
                ...
                .provider;
            let main_turn_specs =
                actor.turn_base_tool_specs(&actor.prepare_tool_definitions().await, provider);
